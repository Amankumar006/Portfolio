      ...
      <div className="about-content px-1 sm:px-1 md:px-3 lg:px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="lg:w-2/5 relative">
            ...
            {/* Floating label */}
            <div className="about-reveal absolute -bottom-4 left-8 bg-white text-black px-6 py-3 rounded-full">
          ...
          <div className="lg:w-3/5 flex flex-col justify-center">
            ...
            <div className="interests-container">
              <p className="about-reveal text-sm uppercase tracking-[0.3rem] text-white/40 font-light mb-6">
                When I'm not coding
              </p>
              ...
              <div className="space-y-4">
                {interests.map((item, index) => (
                  <div
                    key={index}
                    className="interest-item group flex items-center gap-6 py-3 border-b border-white/10 hover:border-white/30 transition-colors duration-300"
                  >
