...
const ProjectJourney = () => {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
            {/* Background Elements - reduced blur on mobile for GPU perf */}
            <div className="absolute inset-0 opacity-20 pointer-events-none">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-white/5 rounded-full blur-[40px] md:blur-[100px] animate-pulse" />
                <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-white/10 rounded-full blur-[30px] md:blur-[80px] animate-pulse delay-1000" />
            </div>
